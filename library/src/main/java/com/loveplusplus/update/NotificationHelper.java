...
public class NotificationHelper extends ContextWrapper {
    ...
    public NotificationHelper(Context base) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel mChannel = new NotificationChannel(CHANNEL_ID, "Aplicar atualizações", NotificationManager.IMPORTANCE_LOW);
            mChannel.setDescription("Há uma nova versão do aplicativo");
            mChannel.enableLights(true); //Está na área de trabalho icon Um pequeno ponto vermelho é exibido no canto superior direito
    ...
    private NotificationCompat.Builder getNofity(String text) {
        return new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                ...
                .setContentTitle("Aplicar atualizações")
                .setContentText(text)
    ...
    private int getSmallIcon() {
        //configurar nofication O ícone lê diretamente o ícone da configuração push do Xiaomi
